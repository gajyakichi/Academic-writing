...
% ============================================================
% Introductionの構成ルール（Known-Unknown-やったこと）
% 詳細は WRITING_GUIDELINES.md を参照
% ============================================================

% 【第一段落：Known（知られていること）】
メタボリックシンドローム（MetS）は、中心性肥満、高血圧、脂質異常症、インスリン抵抗性を含む一連の病態として定義され、心血管疾患（CVD）や死亡率のリスク増大との関連から、世界的に公衆衛生上の重大な問題として浮上している\cite{alberti2009harmonizing,grundy2005diagnosis}。長寿と高齢化として知られている日本でさえも、MetSの有病率はここ数十年、生活様式や食習慣の変化と並行して着実に増加している\cite{haruyama2020incidence,hiratsuka2021higher}。日本では、40-74歳を対象とした特定健康診査（特定健診）制度により、全国的なMetSのスクリーニングが実施されており、リスク因子の早期発見と予防に貢献している。また、近年では、MetSの前段階である「前メタボリック症候群（Pre-Metabolic Syndrome, Pre-MetS）」のリスクにも注目が集まっている。Pre-MetSとは、MetS診断基準には達していないものの、腹囲肥満と高血糖、高血圧、脂質異常症のいずれか1つの要素が存在する状態を指す。この段階であっても、高血圧や耐糖能異常が生じていることが多く、これらが心筋のリモデリングや自律神経系の不均衡を引き起こし、心室性不整脈などの致死性不整脈のリスクを高める可能性が指摘されている\cite{dekker2005metabolic,tirandi2022role}。

% 【第二段落：Unknown（知られていないこと）】
しかしながら、MetSおよびPre-MetSの有病率と心臓突然死（Sudden Cardiac Death, SCD）の発生率との直接的な関連性については、十分に検討されていない。特に、日本の都道府県ごとのMetS有病率の地域差が、SCD発生率にどのように影響するかは明らかになっていない。また、SCDの初期心電図波形は、心室細動や心室頻拍などの電気的除細動が可能なshockable rhythmと、無脈性電気活動や心静止などのnon-shockable rhythmに分類されるが、MetSやPre-MetSがこれらの異なるリズムタイプとどのように関連するかは解明されていない。さらに、Pre-MetSの段階からSCDリスクが上昇するかについても、大規模な疫学的検討は行われていない。

% 【第三段落：やったこと（本研究の目的）】
本研究では、日本の全都道府県を対象に、特定健診データを活用し、MetSおよびPre-MetSの有病率とSCDの発生率との相関を検討する。特に、shockable rhythm（心室細動や心室頻拍）とnon-shockable rhythm（無脈性電気活動や心静止）それぞれについて分析を行い、地域差がSCDリスクに及ぼす影響を明らかにすることを目的とする。全国的な院外心停止登録データ（All-Japan Utstein Registry）と特定健診データを統合することにより、MetSとSCDの関連性を包括的に評価する。
